...
class NewsController extends Controller
{
            ...
            return DataTables::make($data)
                ...
                ->addColumn('img',function ($data){
                    if($data->getFirstMediaUrl('news')){
                        $img = '<img src="'.asset($data->getFirstMediaUrl('news')).'" style="width:25px;height:25px">';
                    }else{
                        $img = '<img src="'.asset('images/no-image.jpg').'" style="width:25px;height:25px">';
                    }
    ...
    public function store(Request $request)
    {
        ...
        $news->short_detail = $request->sortdetail;
        ...
        if($news->save()){
            if($request->file('imgs')){
                ...
                $news->addMedia(storage_path('app/public/').'/'.$newname)->toMediaCollection('news');
            }
