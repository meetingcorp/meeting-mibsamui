            ...
            return DataTables::make($data)
                ...
                ->addColumn('img',function ($data){
                    if($data->getFirstMediaUrl('productcategory')){
                        $img = '<img src="'.asset($data->getFirstMediaUrl('productcategory')).'" style="width:25px;height:25px">';
                    }else{
    ...
    {   
        ...
        if($cate->save()){
            ...
            if($request->file('imgs')){
                ...
                $cate->addMedia(storage_path('app/public/').'/'.$newname)->toMediaCollection('productcategory');
            }
